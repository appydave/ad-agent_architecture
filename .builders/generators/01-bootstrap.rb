KManager.action :bootstrap do
  action do
    application_name = 'ad-agent_architecture'
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'Architecture/Schema for AI Agents',
        ...
        application_lib_namespace:  'Ad::AgentArchitecture',
        namespaces:                 ['Ad', 'AgentArchitecture'],
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 'As a Developer, I want to understand the object graph and workflows for AI agents in multiple scenarios, so that I can build out AI applications effectively',
        copyright_date:             '2024',
        website:                    'http://appydave.com/gems/ad-agent_architecture'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'ad-agent_architecture'
