dsl = Agent.create('YouTube Transcript to Medium Article') do
  attributes do
  ...
  section('Analysis') do
    ...
    step('Update Draft with Intro') do
    ...
    step('Combine Intro Analysis') do
